...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">export interface CountryDropdownProps {
...
export class CultureInfo{
    ...
    public static isValidCulture(value: string): value is Culture {
        ...
        if (parts.length !== 2) <span class="branch-0 cbranch-no" title="branch not covered" >return false;</span>
    ...
    constructor(public cultureInitializer: Culture) {        
        ...
        this._country = (country ? <span class="branch-0 cbranch-no" title="branch not covered" >country : 'US') as Country;</span>
        this._culture = `${this._language}-${this._country}`;
        if (!CultureInfo.isValidCulture(this._culture)) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(`Invalid culture: ${cultureInitializer}`);</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >    public get Culture(): Culture {</span>
<span class="cstat-no" title="statement not covered" >        return this._culture;</span>
<span class="cstat-no" title="statement not covered" >    }</span>
