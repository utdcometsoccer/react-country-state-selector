...
<head>
    <title>Code coverage report for src/components/CountryDropdown/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/CountryDropdown</a> index.tsx</h1>
        <div class='clearfix'>
...
function reducer(state: CountryDropdownState, action: CountryDropdownAction): CountryDropdownState {
  switch (action.type) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case 'SET_COUNTRY': {</span>
<span class="cstat-no" title="statement not covered" >      return { ...state, selectedCountry: action.payload };</span>
...
<span class="cstat-no" title="statement not covered" >      initialCultureInfo = cultureFromBrowser();</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >  } else {</span>
<span class="cstat-no" title="statement not covered" >    initialCultureInfo = cultureFromBrowser();</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
  const initialCountryInformation: CountryInformation[] = <span class="branch-0 cbranch-no" title="branch not covered" >countryInformation ?? [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            dispatch({ type: 'SET_ERROR', payload: `Error loading country information: ${err?.message}\n${err?.stack}` });</span>
<span class="cstat-no" title="statement not covered" >          } else {</span>
<span class="cstat-no" title="statement not covered" >            dispatch({ type: 'SET_ERROR', payload: 'Error loading country information. Please try again later.' });</span>
<span class="cstat-no" title="statement not covered" >          }</span>
...
<span class="cstat-no" title="statement not covered" >    dispatch({ type: 'SET_COUNTRY', payload: e.target.value as Country });</span>
<span class="cstat-no" title="statement not covered" >    onCountryChange(e.target.value);</span>
<span class="cstat-no" title="statement not covered" >  };</span>
&nbsp;
  return (
    &lt;&gt;
      ...
      {state.isLoadingCountryInformation ? (
        ...
        &lt;select
          id="country-select"
          value={state.<span class="branch-0 cbranch-no" title="branch not covered" >selectedCountry ?? ''}</span>
          onChange={handleChange}
          className={<span class="branch-0 cbranch-no" title="branch not covered" >classNameSelect ?? undefined}</span>
          aria-labelledby={Label ? <span class="branch-0 cbranch-no" title="branch not covered" >'country-select-label' : undefined}</span>
          aria-describedby={state.<span class="branch-0 cbranch-no" title="branch not covered" >error ? 'country-error' : u</span>ndefined}
        &gt;
...
&nbsp;
// Removed ImportMeta global declaration since 'import.meta.env' is no longer used.</pre></td></tr></table></pre>
