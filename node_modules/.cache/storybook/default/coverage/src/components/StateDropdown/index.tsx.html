...
<head>
    <title>Code coverage report for src/components/StateDropdown/index.tsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../index.html">All files</a> / <a href="index.html">src/components/StateDropdown</a> index.tsx</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">3x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span></td><td class="text"><pre class="prettyprint lang-js">import { type ChangeEvent, type FC, useEffect, useReducer } from 'react';
...
function reducer(state: StateDropdownState, action: StateDropdownAction): StateDropdownState {
  switch (action.type) {
<span class="branch-0 cbranch-no" title="branch not covered" >    case 'SET_STATE': {</span>
<span class="cstat-no" title="statement not covered" >      return { ...state, selectedState: action.payload };</span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >    case 'SET_CULTURE':</span>
<span class="cstat-no" title="statement not covered" >      return { ...state, culture: action.payload };</span>
    case 'SET_ERROR':
...
const StateDropdown: FC&lt;StateDropdownProps&gt; = ({ getStateProvinceInformation, selectedState, onStateChange, country, culture, Label, classNameLabel, classNameSelect }) =&gt; {
  ...
  if (culture instanceof CultureInfo) <span class="branch-0 cbranch-no" title="branch not covered" >{</span>
<span class="cstat-no" title="statement not covered" >    initialCultureInfo = culture;</span>
...
<span class="cstat-no" title="statement not covered" >      if (typeof country !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >        initialCultureInfo = new CultureInfo(`en-${country}`);</span>
<span class="cstat-no" title="statement not covered" >      } </span>
<span class="cstat-no" title="statement not covered" >    }</span>
<span class="branch-0 cbranch-no" title="branch not covered" >  } else if (typeof country !== 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    initialCultureInfo = new CultureInfo(`en-${country}`);</span>
<span class="cstat-no" title="statement not covered" >  }</span>
&nbsp;
...
<span class="branch-0 cbranch-no" title="branch not covered" >        } catch (err: any) {</span>
<span class="cstat-no" title="statement not covered" >          if (process.env.NODE_ENV === 'Development') {</span>
<span class="cstat-no" title="statement not covered" >            dispatch({ type: 'SET_ERROR', payload: `Error loading state/province information: ${err?.message}\n${err?.stack}` });</span>
<span class="cstat-no" title="statement not covered" >          } else {</span>
<span class="cstat-no" title="statement not covered" >            dispatch({ type: 'SET_ERROR', payload: 'Error loading state/province information. Please try again later.' });</span>
<span class="cstat-no" title="statement not covered" >          }</span>
...
&nbsp;
  const handleChange = <span class="fstat-no" title="function not covered" >(e: ChangeEvent&lt;HTMLSelectElement&gt;) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    dispatch({ type: 'SET_STATE', payload: e.target.value });</span>
<span class="cstat-no" title="statement not covered" >    onStateChange(e.target.value);</span>
<span class="cstat-no" title="statement not covered" >  };</span>
&nbsp;
  return (
    &lt;&gt;
      {state.<span class="branch-0 cbranch-no" title="branch not covered" >error &amp;&amp; &lt;div style={{ color: 'red' }}&gt;{state.error}&lt;/div&gt;}</span>
      &lt;label
        htmlFor="state-province-select"
        className={<span class="branch-0 cbranch-no" title="branch not covered" >classNameLabel ?? undefined}</span>
        aria-label={Label}
      &gt;
        {Label}
      &lt;/label&gt;
      {state.isLoadingStateProvinceInformation ? (
        ...
        &lt;select
          ...
          value={state.<span class="branch-0 cbranch-no" title="branch not covered" >selectedState ?? ''}</span>
          onChange={handleChange}
          className={<span class="branch-0 cbranch-no" title="branch not covered" >classNameSelect ?? undefined}</span>
          aria-labelledby={Label ? <span class="branch-0 cbranch-no" title="branch not covered" >'state-province-select-label' : undefined}</span>
          aria-describedby={state.<span class="branch-0 cbranch-no" title="branch not covered" >error ? 'state-province-error' : u</span>ndefined}
        &gt;
...
&nbsp;
export default StateDropdown;</pre></td></tr></table></pre>
