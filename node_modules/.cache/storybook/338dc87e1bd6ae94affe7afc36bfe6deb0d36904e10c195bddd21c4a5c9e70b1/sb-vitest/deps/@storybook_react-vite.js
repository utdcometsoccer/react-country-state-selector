...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await import("./react-18-HXMKCFMC.js"), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? import_react2.default.createElement(Story, { ...storyContext }) : import_react2.default.createElement(ErrorBoundary, { key: storyContext.id, showMain, showException }, import_react2.default.createElement(Story, { ...storyContext })), element = Wrapper ? import_react2.default.createElement(Wrapper, null, content) : content;
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./test-ACSRRASK.js"), act = await getAct();
